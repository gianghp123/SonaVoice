...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_gianghp123_SonaVoice_api_internal_modules_learning_dtos_req.GrammarAnalyzeTextReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/learning/grammar/sessions/{sessionId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_gianghp123_SonaVoice_api_internal_core_response.BaseResponse-array_github_com_gianghp123_SonaVoice_api_internal_modules_learning_dtos_res_GrammarAIResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "github_com_gianghp123_SonaVoice_api_internal_core_response.BaseResponse-array_github_com_gianghp123_SonaVoice_api_internal_modules_learning_dtos_res_GrammarAIResult": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "github_com_gianghp123_SonaVoice_api_internal_modules_learning_dtos_req.ConversationTurn": {
            "type": "object",
            "properties": {
                "role": {
        ...
        "github_com_gianghp123_SonaVoice_api_internal_modules_learning_dtos_req.GrammarAnalyzeTextReq": {
            "type": "object",
            "required": [
                "transcript"
            ],
            "properties": {
                "conversationContext": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_gianghp123_SonaVoice_api_internal_modules_learning_dtos_req.ConversationTurn"
                    }
                },
                "explanationLanguage": {
                    "type": "string"
